# HALONG24H - HOTEL BOOKING WEBSITE
<br>
...
2. Tải tệp gzip "halong24h" từ github repo này, giải nén và copy toàn bộ thư mục
...
6. Tạo database "halong24h"

7. Import `halong24h.sql` file vào database vừa tạo

8. Paste URL này vào trình duyệt `http://localhost/halong24h/index.php`

9. Để truy cập trang quản lý, sử dụng link tài khoản sau:
    
   `http://localhost/halong24h/admin/index.php`
